...
Responsabilidades:
    - Gestionar y administrar la base de datos completa de donantes de sangre, incluyendo operaciones de creación, lectura, actualización y eliminación de registros.
    - Mostrar interfaz de usuario para permitir la intereccion de la perosna con el sistema, donde le muestra el menu, las opciones y los resultados.
